...
function blankslate_enqueue() {
  ...
  wp_enqueue_style( 'compiled-style', get_template_directory_uri().'/css/style.css' );
  wp_deregister_script( 'jquery' );
  wp_register_script( 'jquery', "https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js", array(), '3.6.1' );
  wp_enqueue_script( 'full-page-overlay-search', get_template_directory_uri().'/js/full-page-overlay-search.js', array('jquery'), '');
}
...
include('inc/functions-ajax-callbacks.php');

// Including ACF Fields and Media into Search:
